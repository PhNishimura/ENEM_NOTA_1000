...
function App() {
  ...
  const testimonials = [
    { name: "João Vitor Madero", score: "960", text: "Depois que li as dicas e entendi as competências e consegui melhorar minha nota na redação!", course: "ENEM 2024 - Eng. Auto. e Controle" },
    { name: "Pedro Henrique", score: "920", text: "Incrível como dicas simples podem fazer tanta diferença. Sai de 520 para 920 na redação", course: "ENEM 2023 - Ciência da Computação" },
    { name: "Mariana Oliveira", score: "1000", text: "Melhor investimento que já fiz. Depois que melhorei minha redação tive o poder de escolher qual universidade queria.", course: "ENEM 2024 - Medicina" },
    { name: "Lucas Almeida", score: "960", text: "O material é direto ao ponto e muito eficaz. Consegui aumentar minha nota em mais de 300 pontos em pouco tempo!", course: "ENEM 2023 - Direito" },
    { name: "Matheus Silva", score: "1000", text: "Com o material e a correção com segui passar na universidade que tanto sonhei! UFRJ", course: "ENEM 2023 - Psicologia" },
    { name: "João Pereira", score: "1000", text: "As correções detalhadas fizeram toda a diferença, agora estou na UFMG!", course: "ENEM 2023 - Direito" },
    { name: "Carolina Martins", score: "975", text: "O acompanhamento fez toda a diferença, hoje estudo na UFPE!", course: "ENEM 2023 - Arquitetura e Urbanismo" },
    { name: "Gabriel Fernandes", score: "965", text: "O método fez minha redação melhorar muito!", course: "ENEM 2023 - Jornalismo" },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4">
                ...
                {/* BOTÃO GRANDE */}
                <a href="#promocao" className="bg-blue-600 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-blue-700 transition-all transform hover:scale-105 shadow-lg flex items-center justify-center group text-center">
                  <span>
                    Garanta sua NOTA 1000 <br /> e uma CORREÇÃO personalizada!
                  </span>
                  <ArrowRight className="ml-2 h-5 w-5 group-hover:translate-x-1 transition-transform" />
                </a>

                {/* BOTÃO MENOR (com padding vertical reduzido) */}
                <a href="#resultados" className="border-2 border-gray-300 text-gray-700 px-8 py-3 rounded-xl text-lg font-semibold hover:border-blue-600 hover:text-blue-600 transition-colors">
